    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('admin/paket')}}" class="nav-link {{ ($menu == 'paket') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{url('admin/pelanggan')}}" class="nav-link {{ ($menu == 'pelanggan') ? 'active' : '' }}">
          ...
          <li class="nav-item  {{ ($menu == 'sudahbayar' || $menu == 'jatuhtempo' || $menu == 'bulanini' || $menu == 'bayartagihan') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ ($menu == 'sudahbayar' || $menu == 'jatuhtempo' || $menu == 'bulanini' || $menu == 'bayartagihan') ? 'active' : '' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/tagihan/sudahbayar')}}" class="nav-link {{ ($menu == 'sudahbayar') ? 'active' : '' }} ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sudah Bayar</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('admin/tagihan/jatuhtempo')}}" class="nav-link {{ ($menu == 'jatuhtempo') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Jatuh Tempo</p>
                </a>
              </li>
              {{-- <li class="nav-item">
                <a href="{{url('admin/tagihan/bulanini')}}" class="nav-link {{ ($menu == 'bulanini') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tagihan Bulan Ini</p>
                </a>
              </li> --}}
              <li class="nav-item">
                <a href="{{url('admin/tagihan/bayartagihan')}}" class="nav-link {{ ($menu == 'bayartagihan') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Bayar Tagihan</p>
                </a>
              </li>
          ...
          {{-- <li class="nav-item">
            <a href="{{url('admin/usermanage')}}" class="nav-link {{ ($menu == 'usermanage') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{url('admin/profile')}}" class="nav-link {{ ($menu == 'profile') ? 'active' : '' }}">
